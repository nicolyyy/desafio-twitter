...
<div class="input-group" style="position: relative; top: 480px; width: 100%; margin-right: auto; margin-left: auto;" >
  <input style="height: 100px; border: 1px solid  rgba(21, 32, 43, 0.5);" type="text" class="form-control" placeholder="O que está acontecendo?" aria-label="Recipient's username with two button addons" aria-describedby="button-addon4">
  <div class="input-group-append" id="button-addon4">
    <button class="btn btn-primary" style="height: 40px; top: 30%; left: 10%;" type="button" style="border-radius: 30%;">Tweetar</button>
  </div>
</div>
...
<div class="card" style="position: relative; margin: 20px; top: 580px; width: 50%; margin-right: auto; margin-left: auto; background-color: rgb(21, 32, 43);">
  ...
  <div class="card-body" style=" color: white;">
    ...
    <h5 style="margin-top: 5px;" class="card-title">Special title treatment</h5>
